    ...
    <footer class="site-footer">
        <div class="footer-main">
            ...
            <div class="footer-brand">
                <img src="<?php echo esc_url(pp_asset('assets/images/logo/logo-full-white.png')); ?>" alt="Pool Party" class="footer-logo">
